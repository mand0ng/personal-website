...
export default function CardItemPromo({ item }) {
    return (


        <div className="bg-white shadow-md rounded-lg max-w-xs dark:bg-gray-800 dark:border-gray-700 m-auto">
            <a className="">
                {/* <img className="rounded-t-lg p-8" src="https://i.ibb.co/KqdgGY4/cosmetic-packaging-mockup-1150-40280.webp" alt="product image" /> */}
                {/* <img className="mx-auto max-w-xs lg:max-w-fit max-h-xs lg:max-h-52 rounded-t-lg p-3 lg:p-3" src={item.img_url} alt="product image" /> */}
                <img className="mx-auto  rounded-t-lg p-3 lg:p-3" src={item.img_url} alt="product image" />
            </a>
            <div className="px-5 pb-5">
                ...
                <div className="flex items-center justify-between">
                    <span className="text-xs md:text-m lg:text-3xl font-bold text-gray-900 dark:text-white">{item.promo}</span>
